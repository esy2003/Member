	...
	public static void main(String[] args) {
		...
		do {
			...
			case UPDATE:
				...
				member.setUserPw(JOptionPane.showInputDialog("바꿀비번"));
				member.setName(JOptionPane.showInputDialog("바꿀이름"));
				member.setSSN(JOptionPane.showInputDialog("바꿀주민"));
